...
[![My Skills](https://skillicons.dev/icons?i=react,typescript,js,html,css,vite,nextjs,dart,androidstudio,php,python,arduino,cpp,java,tailwind,sass,bootstrap,materialui,nodejs,express,mongodb,mysql,netlify,firebase,vercel,prisma,sequelize,postman,figma,git,github,githubactions,bash,vscode,md)](https://skillicons.dev)
