...
[![My Skills](https://skillicons.dev/icons?i=react,vue,typescript,js,html,css,vite,nextjs,dart,androidstudio,php,python,arduino,cpp,java,tailwind,sass,bootstrap,materialui,nodejs,express,mongodb,mysql,netlify,firebase,vercel,prisma,sequelize,postman,figma,git,github,githubactions,docker,linux,ubuntu,bash,vim,vscode,md,pnpm,yarn,bun)](https://skillicons.dev)
...
<p align="center">
  ...
  <a href="https://roadmap.sh">
    <img width="50%" src="https://api.roadmap.sh/v1-badge/wide/643cb546e2725773748fabde?variant=dark&roadmaps=react%2Ctypescript%2Cjavascript%2Cnodejs" alt="roadmap.sh">
  </a>
  <a href="https://leetcode.com/Carlos-Tabangay">
    <img width="47.5%" src="https://leetcard.jacoblin.cool/Carlos-Tabangay?theme=dark">
  </a>
</p>
